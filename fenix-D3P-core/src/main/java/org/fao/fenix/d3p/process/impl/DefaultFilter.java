...
public class DefaultFilter extends org.fao.fenix.d3p.process.Process<DataFilter> {
    ...
    public Step process(Connection connection, DataFilter params, Step... sourceStep) throws Exception {
        ...
        if (tableName!=null && dsd!=null) {
            ...
            step.setData(getCacheStorage().load(null,null,params,new Table(source.getData(), source.getDsd())));
            return step;
        } else
...
/*
    private String createFilterQuery(Order ordering, DataFilter filter, Table table, Collection<Object> params) throws Exception {
