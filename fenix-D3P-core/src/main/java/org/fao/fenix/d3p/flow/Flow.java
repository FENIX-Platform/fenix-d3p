...
public abstract class Flow {
    ...
    public abstract Map<StepId, Resource<DSDDataset,Object[]>> process(Map<StepId,TableStep> sourceSteps, Set<StepId> resultRidList, Process[]processes, org.fao.fenix.commons.process.dto.Process[] flow, boolean lazy) throws Exception;
